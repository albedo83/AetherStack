...
| Frame selection | Support automatic thresholds and an interactive review without changing metrics. | Strict metrics plus review decisions, undo, stable sorting, and Blink state model implemented; automatic rule evidence, CFA validation, preview renderer, and desktop surface planned |
